...
local function MRPInitEntities()
    ...
    MRP.WeaponClasses = {
        "cw_kk_ins2_at4",
        "cw_kk_ins2_squad_fn_maximi_mk1",
        "cw_kk_ins2_squad_fn_minimi_mk1",
        "cw_kk_ins2_squad_fn_minimi_mk3",
        "cw_kk_ins2_squad_fn_scarh_pr",
        "cw_kk_ins2_giat_famas_f1",
        "cw_kk_ins2_giat_famas_felin",
        "cw_kk_ins2_giat_famas_inf",
        "cw_kk_ins2_giat_famas_valorise",
        "cw_kk_ins2_giat_frf2",
        "cw_kk_ins2_giat_pamas_g1",
        "cw_kk_ins2_glock17_gen5",
        "cw_kk_ins2_hk416_fc",
        "cw_kk_ins2_hk416_fs",
        "cw_kk_ins2_hk417_dmr",
        "cw_kk_ins2_pgm_hecate_2",
    }
...
MRP.classId = {
    ...
    ["mrp_fn_maximi_mk1"] = 42,
    ["mrp_fn_minimi_mk1"] = 43,
    ["mrp_fn_minimi_mk3"] = 44,
    ["mrp_fn_scarh_pr"] = 45,
    ["mrp_giat_famas_f1"] = 46,
    ["mrp_giat_famas_felin"] = 47,
    ["mrp_giat_famas_inf"] = 48,
    ["mrp_giat_famas_valorise"] = 49,
    ["mrp_giat_frf2"] = 50,
    ["mrp_giat_pamas_g1"] = 51,
    ["mrp_glock17_gen5"] = 52,
    ["mrp_hk416_fc"] = 53,
    ["mrp_hk416_fs"] = 54,
    ["mrp_hk417_dmr"] = 55,
